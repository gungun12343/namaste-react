            ...
            {items.map((res) => (
                <div className="item py-5 pl-5 items-center border-b border-solid border-gray-300 mb-5 flex" key={res.card.info.id} >
                    ...
                    <div className="right w-2/5 relative">
                        <button className="absolute md:left-[42px] bottom-[-12px] border border-solid border-gray-300 md:px-10 font-bold text-green-600 rounded-xl py-2 bg-white">ADD</button>
